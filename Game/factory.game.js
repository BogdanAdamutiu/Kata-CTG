...
module.exports = (player1, player2, deck, health, maxManaslots) => {
    player1 = Player(Health(health), Manaslots(maxManaslots), Deck(deck), Hand());
    player2 = Player(Health(health), Manaslots(maxManaslots), Deck(deck), Hand());
